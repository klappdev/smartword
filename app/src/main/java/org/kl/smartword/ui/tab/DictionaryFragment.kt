...
class DictionaryFragment(var hidden: Boolean = false) : Fragment() {
    ...
    private fun initLessons() {
        listLessons = arrayListOf(
            Lesson(1, R.drawable.lesson_icon, "first lesson",  "", DateUtil.currentDateTime(), false),
            Lesson(2, R.drawable.lesson_icon, "second lesson", "", DateUtil.currentDateTime(), false),
            Lesson(3, R.drawable.lesson_icon, "third lesson",  "", DateUtil.currentDateTime(), false),
            Lesson(4, R.drawable.lesson_icon, "fourth lesson", "", DateUtil.currentDateTime(), false),
            Lesson(5, R.drawable.lesson_icon, "fifth lesson",  "", DateUtil.currentDateTime(), false)
        )
    }
}